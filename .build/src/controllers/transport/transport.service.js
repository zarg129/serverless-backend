...
let TransportService = class TransportService {
    constructor(transportRepository, databaseService) {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return (yield this.databaseService.find(transport_entity_1.TransportEntity));
            }
            catch (err) {
    ...
    addTransport(transport) {
        return __awaiter(this, void 0, void 0, function* () {
            const transportEntity = new transport_entity_1.TransportEntity();
            ...
            yield this.databaseService.insert(transport_entity_1.TransportEntity, transportEntity);
        });
    }
    deleteTransport(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.databaseService.delete(transport_entity_1.TransportEntity, uuid);
        });
    }
    updateTransport(uuid, transport) {
        return __awaiter(this, void 0, void 0, function* () {
            const transportEntity = new transport_entity_1.TransportEntity();
            transportEntity.licensePlate = transport.licensePlate;
            transportEntity.status = transport.status;
            ...
            if (!validateEmptyObject(transportEntity)) {
                yield this.databaseService.update(transport_entity_1.TransportEntity, uuid, transportEntity);
            }
        });
    }
};
